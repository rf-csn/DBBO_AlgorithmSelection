...
void example_experiment(IOHprofiler_random_state_t *random_generator) {
  ...
  if(strcmp(suite_name,"WModel")==0){
    suite    = IOHprofiler_suite(suite_name, suite_instances,suite_options,layer_number,layer_parameters,dimensions);
  }else{suite    = IOHprofiler_suite(suite_name, suite_instances,suite_options,NULL,NULL,NULL);}
